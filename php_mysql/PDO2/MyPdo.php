...
// $mypdo->exec('delete from student where ids = 16');

/*if($mypdo->exec("insert into student values(null,'三蹦子','男','寡妇村')"));
	echo "自动增长的编号是：".$mypdo->lastInsertId();*/

$list = $mypdo->fetchColumn("select count(*) from student",'num');
echo '<pre>';
var_dump($list);
